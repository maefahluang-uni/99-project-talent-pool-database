    ...
    <>
      ...
      <main className=" p-4">
        <div className="flex justify-end space-x-2 px-2 mb-4">
          <button
            onClick={GoToAvailableposition}
            className="hover:bg-gray-600 text-black font-bold py-2 px-2 rounded border border-black"
          >
            Available position
          </button>
          <button
            onClick={GoToAddVacancies}
            className="bg-black hover:bg-gray-600 text-white font-bold py-2 px-2 rounded border border-black"
          >
            Add Vacancies
          </button>
        </div>
          ...
          <div className="rounded shadow-lg p-5">
            ...
            <div className="flex justify-between">
              <div className="flex items-center">
                ...
                <div className=" p-2 mr-2">
                  ...
                  <img
                    src="../src/assets/vacancies/PositionTitle.png"
                    alt="PositionTitle.png"
                    className="h-10"
                  />
                </div>
                {/* Second column */}
              ...
              <div className="flex items-center">
                ...
                <div className="mr-2">
                  <img
                    src="../src/assets/vacancies/Salary.png"
                    alt="Salary.png"
                    className="h-10"
                  />
                </div>
            ...
            <div className="flex justify-between">
              <div className="flex items-center">
                ...
                <div className=" p-2 mr-2">
                  <img
                    src="../src/assets/vacancies/PositionApplied.png"
                    alt="PositionApplied.png"
                    className="h-10"
                  />
                </div>
                {/* Second column */}
              ...
              >
                ...
                <div className="mr-2">
                  <img
                    src="../src/assets/vacancies/Dateofapplication.png"
                    alt="Salary.png"
                    className="h-10"
                  />
                </div>
            ...
            <div className="flex justify-between">
              <div className="flex items-center">
                ...
                <div className=" p-2 mr-2">
                  <img
                    src="../src/assets/vacancies/Nationalities.png"
                    alt="PositionApplied.png"
                    className="h-10"
                  />
                </div>
            ...
            <div className=" flex justify-center items-center py-4">
              <div className="  flex flex-col items-center px-72">
                <button
                  onClick={GoToRecommendedCandidates}
